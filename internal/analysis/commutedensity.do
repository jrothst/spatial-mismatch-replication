...
forvalues i=1/`nczs' {
  ...
  use commutedist racegp akmsamp if akmsamp==1 ///
...
if "`havegp3'"=="1" append using `group3'
 sort czgroup distpt
 label var dens_r0 "White non-hispanic"
 label var dens_r1 "Black non-hispanic"
 ...
 save ${output}/commutedensity.dta, replace
